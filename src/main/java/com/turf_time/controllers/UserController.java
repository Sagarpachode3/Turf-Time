...
public class UserController {
	...
	//PUT - Reset Password
	@PutMapping("/res-pass")
	public ResponseEntity<ApiResponse> resetUserPass(@Valid @RequestBody PasswordResetDto passwordResetDto){
		this.userService.updateUserPassword(passwordResetDto.getEmail(),passwordResetDto.getPassword());
